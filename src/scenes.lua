...
function multiplay()
	...
	while true do
		...
		tap(674, 1101)
		ramdomSleep(1000)
		xEventVS, yEventVS = findColor({59, 212, 673, 985},
			"0|0|0x61564a,3|3|0xe8e6e5,7|11|0x4e4135,12|11|0xdcd9d7,13|4|0xffffff,28|-1|0x594c3c,26|1|0xffffff,27|9|0xfbfbfa,24|20|0x6c6257,25|18|0xffffff,87|102|0x9d5750,98|104|0x8b2b1a,128|110|0xff9999,189|113|0xa73230,184|113|0xeb857b,409|103|0x3d2f1e,409|106|0xf9f9d7,408|108|0x776d58,409|113|0xffffdd,409|116|0x312213",
			70, 0, 0, 0)
		if xEventVS > -1 then
