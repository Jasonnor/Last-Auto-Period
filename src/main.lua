...
while true do
	ramdomSleep(1000)
	-- Touch Screen
	x, y = findColor({15, 98, 709, 1179},
		"0|0|0xeff1c9,445|-604|0xffff60,197|64|0x685644,454|-38|0x651814,479|-43|0xd5d3d9,544|121|0xffa381,469|161|0xb17276,500|241|0xbb6773,498|340|0xbbbeb6,165|408|0xabaca4,31|410|0x7f818e,40|342|0xc59c7b,199|456|0x5eb7e4,271|112|0x94deff,355|-226|0x807268,275|-305|0x908ab7,167|-292|0xd58486,532|-292|0x97d0de,579|-271|0x92cfe2,-49|-83|0xcfd73d",
		85, 0, 0, 0)
	if x > -1 then
		tap(x, y)
	end
